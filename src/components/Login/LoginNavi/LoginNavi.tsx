    ...
    <Container>
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mx-auto">
          <Link to="#home" className="p-4 text-white">Biz Kimiz</Link>
          <Link to="#link" className="p-4 text-white">Neler Sunuyoruz? </Link>
          <Link to="#home" className="p-4 text-white">Katalog</Link>
          <Link to="#link" className="p-4 text-white">Codecademy</Link>
          <Link to="#home" className="p-4 text-white">Tobeto'da Bu Ay</Link>
        </Nav>
